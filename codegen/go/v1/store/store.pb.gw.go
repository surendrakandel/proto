...
func request_Business_CreateStore_0(ctx context.Context, marshaler runtime.Marshaler, client BusinessClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Business_CreateStore_0(ctx context.Context, marshaler runtime.Marshaler, server BusinessServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateStoreRequest
	var metadata runtime.ServerMetadata
...
func RegisterBusinessHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BusinessServer) error {
	...
	mux.Handle("POST", pattern_Business_CreateStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/store.Business/CreateStore", runtime.WithHTTPPathPattern("/store.Business/CreateStore"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Business_CreateStore_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Business_CreateStore_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBusinessHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BusinessClient) error {
	...
	mux.Handle("POST", pattern_Business_CreateStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/store.Business/CreateStore", runtime.WithHTTPPathPattern("/store.Business/CreateStore"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Business_CreateStore_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Business_CreateStore_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"store.Business", "CreateStore"}, ""))
)

var (
	forward_Business_CreateStore_0 = runtime.ForwardResponseMessage
)
